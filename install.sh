...
wget https://raw.githubusercontent.com/VitalPBX/Festival/master/festival.service
...
cd /etc/asterisk/
wget https://raw.githubusercontent.com/VitalPBX/Festival/master/festival.conf
asterisk -rx"module load app_festival.so"
systemctl restart festival.service
cd /etc/asterisk/ombutel
wget https://raw.githubusercontent.com/VitalPBX/Festival/master/extensions__90-festival.conf
